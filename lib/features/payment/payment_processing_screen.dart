...
import 'dart:async';
import 'dart:math';
import '../order/order_preparation_screen.dart';
  ...
  void initState() {
    ...
    Timer(const Duration(seconds: 3), () {
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(builder: (_) => const OrderPreparationScreen()),
      );
    });
  }
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: const Icon(Icons.credit_card, size: 48, color: Color(0xFF386641)),
                ),
