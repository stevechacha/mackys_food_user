...
import 'package:mackys_partners/features/more/more_screen.dart';
import 'package:mackys_partners/features/order/order_screen.dart';
import 'package:mackys_partners/features/profile/complete_profile_address_screen.dart';
import 'package:mackys_partners/features/meal/meal_detail_screen.dart';
import 'package:mackys_partners/features/notification/notification_screen.dart';
import 'package:mackys_partners/features/explore/search_and_filter_screen.dart';
import 'package:mackys_partners/features/support/support_screen.dart';
import 'package:mackys_partners/widgets/meal_card.dart';
  ...
  Widget _buildProfileCompletionBanner() {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (_) => const CompleteProfileAddressScreen()));
        },
        child: Container(
