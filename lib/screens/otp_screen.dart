...
class OTPScreen extends StatefulWidget {
  ...
  const OTPScreen({Key? key, required this.phoneNumber, this.onVerified}) : super(key: key);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Enter the code sent to ${widget.phoneNumber.substring(0, 4)}****${widget.phoneNumber.substring(widget.phoneNumber.length - 3)} via WhatsApp',
